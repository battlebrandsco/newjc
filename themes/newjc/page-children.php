...
<section class="has-no-padding">
    <div class="hero">
        <div class="hero-panel">
            <h1>Kingdom Sparks</h1>
            <p class="has-width-50 is-centered is-yellow">Spark World is available during 11 AM services each Sunday and some special services upon request.</p>
        </div>
    </div>
</section>
<section class="has-no-padding">
    <div class="container is-half">
        <div class="grid">
            <div class="col has-text-align-center">
                <hr />
                <p>Sundays are certainly worth looking forward to, especially in Spark World! In Spark World your child will be challenged with life changing Biblical truths in fun and engaging ways such as music, conversations, arts and crafts and more in a safe environment. Spiritually, it is very important to reach and teach children where they are and Sundays are a perfect opportunity for that. Outside of Sundays, we believe that every day is important in a child’s life and the role of each parent/guardian is valued and vital to each child’s success.</p>
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="container has-width-50 is-centered has-text-align-center">
        <div class="grid">
            <div class="col">
